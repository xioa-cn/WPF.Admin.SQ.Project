namespace WPF.Admin.UserLogger
{
    public interface IUserLogService
    {
        ...
        /// <param name="path">日志文件路径</param>
        void LogInfo(string message, string path = "");
        ...
        /// <param name="path">日志文件路径</param>
        void LogError(string message, Exception? ex = null, string path = "");
        ...
        /// <param name="ex">异常对象（可选）</param>
        /// <param name="path">日志文件路径</param>
        void LogFatal(string message, Exception? ex = null, string path = "");
        ...
        /// <param name="path">日志文件路径</param>
        void LogUserAction(string userName, string action, string details, string path = "");
    }
}